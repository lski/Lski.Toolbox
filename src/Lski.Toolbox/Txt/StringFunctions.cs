...
namespace Lski.Toolbox.Txt
{
    ...
    {
        /// <summary>
        /// Converts a numeric to an Alpha representation e.g. 1 => A, 27 => AA etc
        /// </summary>
        ...
        /// </summary>
        public static string ConcatWs(string separator, params Object[] objs) => ConcatWs(objs, separator);
        ...
        /// <returns></returns>
        public static string ExtendedTrim(this string str, bool emptyStringOnNull = true)
        {
            if (str == null)
            {
