...
{
    /// <summary>
    /// Methods to convert an object to a dictionary 
    /// </summary>
    public static class Convert
    {
        ...
        public static Dictionary<string, object> ToDictionary<T>(T o)
        {
            ...
            var props = GetProperties(typeof(T), false).Where(p => p.CanRead);
        ...
        {
            var props = GetProperties(obj.GetType(), true).Where(p => p.CanWrite);
