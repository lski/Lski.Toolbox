...
namespace IfacesEnumsStructsClasses {
	...
	public interface DWebBrowserEvents2 {
		...
		//        
		[DispId(250)]
		void BeforeNavigate2([MarshalAs(UnmanagedType.IDispatch)]
object pDisp, [In()]
ref object URL, [In()]
ref object Flags, [In()]
ref object TargetFrameName, [In()]
ref object PostData, [In()]
ref object Headers, [In(), Out(), MarshalAs(UnmanagedType.VariantBool)]
ref bool Cancel);
		[DispId(0xfb)]
		void NewWindow2([In(), Out(), MarshalAs(UnmanagedType.IDispatch)]
ref object ppDisp, [In(), Out(), MarshalAs(UnmanagedType.VariantBool)]
ref bool Cancel);
		[DispId(0xfc)]
		void NavigateComplete2([MarshalAs(UnmanagedType.IDispatch)]
object pDisp, [In()]
ref object URL);
		//[DispId(0x103)]
